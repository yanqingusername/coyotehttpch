<?php /*a:2:{s:71:"/Applications/phpstudy/coyotehttpch/application/cms/view/field/add.html";i:1632904468;s:76:"/Applications/phpstudy/coyotehttpch/application/admin/view/index_layout.html";i:1596779062;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div id="options" style="display:none">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <input type="radio" lay-filter="datasource" name="setting[datastate]" value="2" title="联动菜单">
                        <input type="radio" lay-filter="datasource" name="setting[datastate]" value="3" title="关联栏目">
                    </div>
                </div>
                <div class="layui-form-item datasource" style="display:none">
                    ...
                    <div class="layui-input-inline w190">
                        <select lay-filter="datatable" name="setting[datasource][datatable]">
                            ...
                            <option value="<?php echo htmlentities($vo['name']); ?>"><?php echo htmlentities($vo['comment']); ?> [<?php echo htmlentities($vo['name']); ?>]</option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                ...
                <div class="layui-form-item linksource" style="display:none">
                    ...
                    <div class="layui-input-inline w190">
                        <select lay-filter="datalink" name="setting[linksource][dataid]">
                            ...
                            <option value="<?php echo htmlentities($vo['id']); ?>"><?php echo htmlentities($vo['catname']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                    <div class="layui-input-inline w150">
                        <select id="linkvalue" name="setting[linksource][datavalue]">
                            <option data-define="" value="1">层级【1级】</option>
                            <option value="2">层级【2级】</option>
                            <option value="3">层级【3级】</option>
                        </select>
                    </div>
                </div>
                <div class="layui-form-item menusource" style="display:none">
                    <label class="layui-form-label">栏目</label>
                    <div class="layui-input-inline w190">
                        <select lay-filter="datatable" name="setting[menusource][menuid]">
                ...
                <div class="layui-form-item defaultsource" >
...
....." class="layui-textarea"></textarea>
            ...
            <input name="modelid" type="hidden" value="<?php echo htmlentities($modelid); ?>" />
            <div class="layui-form-item">
...
layui.use(['layer', 'form'], function() {
    ...
    form.on('select(datalink)', function(data) {
        var field = data.value;
        $.get('<?php echo url("getfieldinfo"); ?>', {field:field}, function(res) {
            if(res.code==1){
                var data = res.data;
