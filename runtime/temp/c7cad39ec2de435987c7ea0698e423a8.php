<?php /*a:2:{s:83:"/www/wwwroot/kyd.web.zhongwangyingtong.com/application/index/view/index/search.html";i:1642057077;s:77:"/www/wwwroot/kyd.web.zhongwangyingtong.com/application/index/view/layout.html";i:1663570090;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
...
<div class="search">
	<div class="core">
		<h2 class="font-bold line-height-1em">搜索结果</h2>
		...
		<div class="search-list">
			...
			<a class="search-list-item" target="_blank" href="<?php echo url($item['type'],['id'=>$item['id']]); ?>">
				<div class="search-item-tip"><?php echo $item['type'] == 'news_details'?'新闻中心':'产品'; ?></div>
